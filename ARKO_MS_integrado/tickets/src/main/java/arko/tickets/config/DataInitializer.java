...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (ticketRepository.count() == 0) {
            ...
            ticket1.setResponsable("admistrador juanito");
            ticket1.setDocumentoId(4L); // Plano Tuberías
            ...
            ticket2.setDocumentoId(3L); // Plano Instalaciones Eléctricas
            ...
            ticket3.setDocumentoId(1L); // Plano Arquitectónico Obra 1
            ...
            ticket4.setDocumentoId(5L); // Presupuesto Obra 2
            ...
            ticket5.setDocumentoId(6L); // Cronograma Obra 2
            ...
            ticket6.setDocumentoId(2L); // Plano CAD Estructura
