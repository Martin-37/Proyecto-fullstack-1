...
public class TicketController {
    ...
    @GetMapping("/{id}/con-documento")
    public ResponseEntity<Map<String, Object>> obtenerConDocumento(
            @PathVariable Long id,
            @RequestHeader("Authorization") String token) {
        return ResponseEntity.ok(ticketService.obtenerConDocumento(id, token));
    }
